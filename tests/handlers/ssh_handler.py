...
class TestSSHHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.username = 'chlupp'  # Replace with your remote username
        self.remote_host = "zenith.metacentrum.cz"  # Replace with your remote host
        self.password = 'Petr.123456'  # Ensure this is set in your environment for security
