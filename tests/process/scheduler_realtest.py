...
class TestScheduler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.remote_work_dir = "/storage/brno2/home/chlupp/scheduler_test"
        ...
        self.username = "chlupp"
        self.ssh_password = 'Petr.123456'
    ...
    def test_submit_jobs(self):
        ...
        self.scheduler.submit_jobs(bucket_name=self.bucket_name,
                                   ...
                                   python_script_path='/storage/brno2/home/chlupp/scheduler_test/test.py',
                                   use_gpu=False,
                                   resources=resources,
    ...
    def test_monitor_jobs(self):
        user_email = "petaschlup@seznam.cz"
