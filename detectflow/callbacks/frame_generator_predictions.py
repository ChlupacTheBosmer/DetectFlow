...
def test_callback(**kwargs): #TODO: Rename the callback function
    ...
    **kwargs -- A dictionary of keyword arguments where key is the argument name and value is the argument value.
    ...
    model_defaults = {0: {'path': "/storage/brno2/home/chlupp/Flowers/flowers_ours_f2s/weights/best.pt",
                          'conf': 0.1},
                      1: {
                          'path': "/storage/brno2/home/chlupp/Dataset Composition Test/751e1107_enrich_single_cls/weights/best.pt",
                          'conf': 0.1}}
