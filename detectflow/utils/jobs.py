...
def parse_qstat_output(job_id, output):
    ...
    Returns:
        dict: A dictionary containing parsed data from the qstat output. Example structure:
        {
            ...
            'job_state': 'F',
            'exit_status': '0',
            'output_path': '/storage/brno2/home/chlupp/deploy/schedule/jobs/cz1-m1_CZ1_M1_AraHir01.out',
            'error_path': '/storage/brno2/home/chlupp/deploy/schedule/jobs/cz1-m1_CZ1_M1_AraHir01.err',
